...
export interface ApiCareerEnquiryCareerEnquiry
  ...
  attributes: {
    applyingFor: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentCTC: Schema.Attribute.String & Schema.Attribute.Required;
    currentLocation: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiCareersPageCareersPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vacancyDetails: Schema.Attribute.Component<'careers-page.vacancy', true>;
  };
}
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaSection: Schema.Attribute.Component<'shared.cta', false>;
    feedback: Schema.Attribute.Blocks;
    feedbackAuthor: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    projectName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Project Name:'>;
    projectYear: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Project Year: '>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiDownloadPageDownloadPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    catalougeItem: Schema.Attribute.Component<
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventImages: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    copyrightText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A9[2025] Muvro Technologies All Rights Reserved'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'footer.global-locations', true>;
    logo: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    menuItem: Schema.Attribute.Component<'footer.footer-menu-items', true>;
...
export interface ApiOurHistoryPageOurHistoryPage
  ...
  attributes: {
    ...
    sectionHeader: Schema.Attribute.Component<'shared.section-header', false>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    timelineCard: Schema.Attribute.Component<
      'our-history-page.history-timeline',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiOurValuesPageOurValuesPage extends Struct.SingleTypeSchema {
  collectionName: 'our_values_pages';
  info: {
    displayName: 'Our Values Page';
    pluralName: 'our-values-pages';
    singularName: 'our-values-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::our-values-page.our-values-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sectionHeader: Schema.Attribute.Component<'shared.section-header', false>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valueCard: Schema.Attribute.Component<'our-values-page.value-card', true>;
  };
}
...
export interface ApiProductPageProductPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    availableDesignsSection: Schema.Attribute.Component<
      'product-page.available-designs',
      false
    >;
    bannerSection: Schema.Attribute.Component<'product-page.banner', false>;
    configureOptionsSection: Schema.Attribute.Component<
      'product-page.configure-options',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaSection: Schema.Attribute.Component<'shared.cta', false>;
    industryApplicationsSection: Schema.Attribute.Component<
      'product-page.industry-applications',
      false
    >;
    introductionSection: Schema.Attribute.Component<
      ...
      false
    >;
    keyComponentsSection: Schema.Attribute.Component<
      'product-page.key-components',
      false
    >;
    ...
    > &
      Schema.Attribute.Private;
    productGallerySection: Schema.Attribute.Component<
    ...
    systemDetailsSection: Schema.Attribute.Component<
      'product-page.system-details',
      false
    >;
    systemSpecificationsSection: Schema.Attribute.Component<
      'product-page.system-specifications',
      false
    >;
    systemVersatilitySection: Schema.Attribute.Component<
      'product-page.system-versatility',
      false
    >;
    tabLayoutSection: Schema.Attribute.Component<
      'product-page.tab-layout',
      false
    >;
    tagline: Schema.Attribute.String;
    technicalSpecificationsSection: Schema.Attribute.Component<
      'product-page.technical-specifications',
      false
    >;
    transparentImage: Schema.Attribute.Media<'images' | 'files'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyChooseUsSection: Schema.Attribute.Component<
      'product-page.why-choose-us',
      false
    >;
    workflowSection: Schema.Attribute.Component<'product-page.workflow', false>;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'productName'> & Schema.Attribute.Required;
    tagline: Schema.Attribute.String;
    transparentImage: Schema.Attribute.Media<'images'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiQualityPolicyPageQualityPolicyPage
  extends Struct.SingleTypeSchema {
  collectionName: 'quality_policy_pages';
  info: {
    displayName: 'Quality Policy Page';
    pluralName: 'quality-policy-pages';
    singularName: 'quality-policy-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::quality-policy-page.quality-policy-page'
    > &
      Schema.Attribute.Private;
    policyPoints: Schema.Attribute.Component<
      'quality-policy-page.policy-points',
      true
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSoftwarePageSoftwarePage
  extends Struct.CollectionTypeSchema {
  collectionName: 'software_pages';
  info: {
    displayName: 'Software Page';
    pluralName: 'software-pages';
    singularName: 'software-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    banner: Schema.Attribute.Component<'software-page.banner', false>;
    content: Schema.Attribute.Blocks & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::software-page.software-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sectionHeader: Schema.Attribute.Component<'shared.section-header', false>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'softwareName'> & Schema.Attribute.Required;
    softwareImages: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    softwareName: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSolutionPageSolutionPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    sectionHeader: Schema.Attribute.Component<'shared.section-header', false>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    solution: Schema.Attribute.Component<'solution-page.solution', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiWhyMuvroPageWhyMuvroPage extends Struct.SingleTypeSchema {
  collectionName: 'why_muvro_pages';
  info: {
    displayName: 'Why Muvro Page';
    pluralName: 'why-muvro-pages';
    singularName: 'why-muvro-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    bannerContent: Schema.Attribute.Blocks & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item: Schema.Attribute.Component<'why-us-page.card-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::why-muvro-page.why-muvro-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sectionHeader: Schema.Attribute.Component<'shared.section-header', false>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::our-values-page.our-values-page': ApiOurValuesPageOurValuesPage;
      'api::product-page.product-page': ApiProductPageProductPage;
      'api::product.product': ApiProductProduct;
      'api::quality-policy-page.quality-policy-page': ApiQualityPolicyPageQualityPolicyPage;
      'api::software-page.software-page': ApiSoftwarePageSoftwarePage;
      ...
      'api::why-muvro-page.why-muvro-page': ApiWhyMuvroPageWhyMuvroPage;
